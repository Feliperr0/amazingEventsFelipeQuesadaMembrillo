...
function filterEvents() {
  filtrarEventos = pastEvents.filter((event) => {

    const buscarTexto = filterTexto.value.toLowerCase()
    const textoEncontrado = event.name.toLowerCase().includes(buscarTexto) || event.description.toLowerCase().includes(searchText)
